...
class Examples extends MY_Controller
{
	...
	public function create_user()
	{
		...
		$user_data = [
			'username'   => 'admin',            //Kang changed for testing
			'passwd'     => 'Simple123',        //Kang changed for testing
			'email'      => 'test@test.com',    //Kang changed for testing        
			'auth_level' => '9', // 9 if you want to login @ examples/index.
                                                            //Kang changed to 9 for testing
		];
